...
- Removed support for CD Digital Audio playback from physical disks.
  ...
  as directories. You can read more in [#260][260].
...
Shortlog (edited to remove some administrative changes). Git users can
re-create raw shortlog with: `git shortlog ^svn/trunk ^v0.75.0-pre v0.75.0-rc1`

Use `git log --grep="subject"` to find out more about specific change.
