...
## <a name="changelog" href="#changelog">§</a> Commit Contributions in Detail

The following tables list merged commits into dosbox-staging, per author.

The list can be re-created using: `git shortlog ^v0.75.0-pre v0.75.0-rc1 --no-merges --reverse`. Details for a specific commit can be described using `git log --grep="subject"`
