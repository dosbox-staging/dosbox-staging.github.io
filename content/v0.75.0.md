...
- dosbox-staging does not run on OS/2
- dosbox-staging does not run on Windows older than XP
- Support for CD Digital Audio playback from physical disks was removed.
  It is still possible to install games distributed on CDs by mounting them
  as directories. TODO more [#260][260]
...
(`r3608`) until SVN trunk `r4336`.  Changes that were backported and released
in 0.74-2 or 0.74-3 are **not** listed in here.
