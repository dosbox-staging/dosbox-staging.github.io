...
- Add new features to the config command (SVN) 143beec6b12b947fb983be54f78952144ab7fe6d
...
The default path was slightly changed to avoid spaces in the default configuration
file name and group all configuration files in a single directory:
