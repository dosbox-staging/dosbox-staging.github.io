...
from DOSBox are clearly marked with "**SVN**".

dosbox-staging 0.75.x development cycle lasted ~8 months (starting in
2019-09-15). Over this period we received **208** pull requests (including
internal pull requests between maintainers). Excluding code from SVN, we
merged code from **11&nbsp;contributors**, who submitted code authored by
**19&nbsp;developers**.

We are extremely thankful for all contributions, including invaluable
improvements merged in from the DOSBox project (SVN).

This changelog is quite massive, so we split it into several sections:

* [1. New features](#new-features)
  * [1.1. Upgrade to SDL 2.0](#sdl2)
  * [1.2. Support FLAC, Opus, Vorbis, and MP3 CD-DA tracks](#cdda)
  * [1.3. Pixel-perfect scaling mode](#pp)
  * [1.4. AUTOTYPE command](#autotype)
  * [1.5. Changed rendering defaults](#rdef)
  * [1.6. Expand mouse control methods](#mouse)
  * [1.7. Nuked OPL v1.8](#nuked)
  * [1.8. Resizable window](#resizable)
  * [1.9. CONFIG command improvements (Git, SVN)](#config)
  * [1.10. Configuration file locations](#xdg)
  * [1.11. 64-bit dynarec (SVN)](#dynarec)
  * [1.12. GLSL shader support (SVN)](#glsl)
  * [1.13. DATE and TIME commands (SVN)](#date)
  * [1.14. CGA emulation improvements (Git, SVN)](#cga)
  * [1.15. Mount overlay support (SVN)](#overlay)
* [2. Removed features](#removed)
* [3. Known issues](#known-issues)
* [4. Workflow changes (for testers and developers)](#devel-features)
* [5. Changelog](#changelog)
  * [5.1. dosbox-staging](#changelog-git)
  * [5.2. Community patches and libraries](#changelog-libs)
  * [5.3. DOSBox SVN](#changelog-svn)

[1]: <https://en.wikipedia.org/wiki/Fork_(software_development)#Forking_of_free_and_open-source_software>

# <a name="new-features" href="#new-features">§</a> New features

## <a name="sdl2" href="#sdl2">§</a> Upgrade to SDL 2.0

Old SDL 1.2 is unmaintained since 2013, upgrade to (very stable at this point) version
2.0 allowed for major code cleanups (removal of old hacks), enabled easy support for
modern graphic APIs, and opened field for new features and improvements.
...
## <a name="cdda" href="#cdda">§</a> Support FLAC, Opus, Vorbis, and MP3 CD-DA tracks

Dependency on old SDL\_sound 1.2 library (unmaintained since 2008) was replaced by
in-tree audio decoder implementation working with SDL 2.0.

This allowed us to expand support for CD Digital Audio emulation using
[cue sheets][cue], independent on codecs installed (or missing) on the operating
system. We're using high-quality decoder implementations provided by battle-tested
**[dr_libs][dr_libs]** and **[stb][stb]** libraries.

Additionally, support for high-quality [Opus][opus] audio format is provided
via **libopus** reference implementation.  Opus provides the best quality/size ratio
out of lossy audio formats.

Following formats are supported:

- Opus - lossy (high quality, small file size)
- FLAC - lossless (high quality, medium file size)
- Vorbis - lossy (high quality, medium file size)
- MP3 - lossy (medium quality, small file size) - popular legacy option
- WAV - lossless (high quality, big file size) - popular legacy option

Also, support goes beyond native CD 44.1kHz stereo: we support CUE files with audio
tracks encoded as 22.05 kHz, 44.1 kHz, 48 kHz; mono, stereo and support for DOS
software playing CD tracks via Digital Audio Extraction.

[cue]: https://en.wikipedia.org/wiki/Cue_sheet_(computing)
[opus]: https://en.wikipedia.org/wiki/Opus_(audio_format)
[dr_libs]: http://mackron.github.io/dr_libs/
...
- Removed support for CD-DA audio emulation via [AIFF][aiff] audio format.
