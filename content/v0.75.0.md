...
- [2. New Features in Detail](#new-features)
  ...
  - [2.9. CONFIG command improvements (Git, SVN)](#config)
  ...
  - [2.14. CGA emulation improvements (Git, SVN)](#cga)
...
- [3. Overview of Changes](#overview)
  ...
  - [3.4. Changes per Author](#author-tally)
...
***Quick-tip***: edit your configuration file straight away by launching
dosbox-staging using the `-editconf` argument.
...
[OpenGL Shading Language (GLSL)][glsl] offloads the task of processing the
game's image to your Graphical Processing Unit (GPU), using its hardware
shaders, instead of performed in software by your CPU.
...
- **11 dosbox-staging contributors** submitted **208** pull requests comprised
  of **735** commits written by **17 authors**.
...
The following is an inventory of dosbox-staging merged commits, broken down
per-author. Commits are listed regardless of the project-of-origin to ensure
all authors with content in dosbox-staging are duly credited.
