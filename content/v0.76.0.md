...
expanded by the community to support POWER8 (64-bit) architecture as
...
two changes to reduce the occurence of these:
...
- When quitting DOSBox Staging, information about the games' GUS audio stream
...
[fluidsynth]
soundfont = name-of-your-soundfont.sf2
```
...
as:
```
soundfont = /path/to/timbres_of_heaven.sf2 20
```

This will reduce the SoundFont's levels to 20% of their original output.
...
Keymapper received tiny usability improvements as well: it displays
...
- Some users of Gnome 3.38.1 experience problems when window is leaving
  fullscreen (both X11 and Wayland). This seems to be a Gnome issue; if you
  experience it as well, please make a report in the bugtracker.
