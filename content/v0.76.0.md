...
*Tip: integer scaling works best for games, that use square pixels;
many DOS games use non-square pixels (often using resolution 320x200 / [PAR] 5:6) - for those titles
sharp&#8209;bilinear scaling (DOSBox Staging default setting) works better.*
