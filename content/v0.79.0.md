...
* 7. [Localization Improvements](#LocalizationImprovements)
  ...
  * 7.3. [Improved Detection of Local Language and Keyboard Layout](#ImprovedDetectionofLocalLanguageandKeyboardLayout)
...
* 9. [General Improvements](#GeneralImprovements)
  * 9.1. [Launch with Specified Config Option(s) From Command-line](#LaunchwithSpecifiedConfigOptionsFromCommand-line)
  ...
  * 9.4. [Workaround for Games that Corrupt Memory](#WorkaroundforGamesthatCorruptMemory)
...
* 11. [Translation Updates](#TranslationUpdates)
* 12. [Bugfixes](#Bugfixes)
* 13. [Contributors](#Contributors)
* 14. [Thank You](#ThankYou)
...
### 7.3. <a name='ImprovedDetectionofLocalLanguageandKeyboardLayout'></a>Improved Detection of Local Language and Keyboard Layout
...
### 9.1. <a name='LaunchwithSpecifiedConfigOptionsFromCommand-line'></a>Launch with Specified Config Option(s) From Command-line
...
### 9.4. <a name='WorkaroundforGamesthatCorruptMemory'></a>Workaround for Games that Corrupt Memory
...
## 11. <a name='TranslationUpdates'></a>Translation Updates
...
## 13. <a name='Contributors'></a>Contributors

 - @John Novak  for all the audio enhancements and shader improvements
 - @FeralChild for the mouse overhaul and codepage enhancements
 - @GranMinigun for the hiDPI and video chain fixes
 - @sherm_p for the messaging ANSI markup system
 - @Wengier for shell improvements and Windows installer
 - @kklobe for paging and memory system refinements 
...
## 14. <a name='ThankYou'></a>Thank You
